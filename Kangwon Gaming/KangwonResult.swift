...
protocol KangwonWebStatusComparable {
...
enum KangwonWebStatus: Equatable, KangwonWebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: KangwonWebStatus) -> Bool {
        switch (self, other) {
...
extension KangwonWebStatus {
    static func == (lhs: KangwonWebStatus, rhs: KangwonWebStatus) -> Bool {
